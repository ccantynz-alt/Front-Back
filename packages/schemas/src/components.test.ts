...
describe("ComponentCatalog", () => {
  ...
  test("each catalog entry is a Zod schema that parses correctly", () => {
    const samples: Record<string, unknown> = {
      ...
      Alert: { component: "Alert", props: { message: "x" } },
      Avatar: { component: "Avatar", props: {} },
      Tabs: { component: "Tabs", props: { items: [{ id: "tab1", label: "Tab1" }] } },
      Select: { component: "Select", props: { options: [{ label: "A", value: "a" }] } },
      Textarea: { component: "Textarea", props: { name: "x" } },
