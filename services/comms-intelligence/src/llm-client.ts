...
export interface LlmCompletionRequest {
  /** A purpose tag the caller provides — e.g. "fraud-score", "intent-classify". */
  purpose: string;
...
/**
 * The pluggable LLM-client contract. The fraud scorer, intent classifier,
 * and voice-agent all call this when they need a generation pass.
 * Tests inject a {@link StubLlmClient}; production wires up
 * {@link HttpAiGatewayClient}.
 */
 ...
 * caller-provided canned response keyed by purpose.
 */
