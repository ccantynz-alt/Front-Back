...
function EmptyState(props: { icon: string; title: string; subtitle: string }): JSX.Element {
  return (
    <Stack direction="vertical" gap="sm" align="center" class="py-16 text-center">
      <Text as="span" variant="caption" class="text-3xl opacity-20">{props.icon}</Text>
      <Text as="span" variant="caption" class="text-sm font-medium" style={{ color: "var(--color-text-secondary)" }}>{props.title}</Text>
      <Text as="span" variant="caption" class="text-xs" style={{ color: "var(--color-text-faint)" }}>{props.subtitle}</Text>
    </Stack>
  );
}
...
export default function ReposPage(): JSX.Element {
  ...
  return (
    <Box class="flex h-screen" style={{ background: "var(--color-bg)" }}>
      ...
      >
        ...
        <Box class="px-5 py-4" style={{ "border-bottom": "1px solid var(--color-border)" }}>
          <Stack direction="horizontal" gap="sm" align="center">
            ...
            <Box>
              <Text variant="h1" class="text-base font-bold" style={{ color: "var(--color-text)" }}>Repositories</Text>
              <Text variant="body" class="text-[10px]" style={{ color: "var(--color-text-faint)" }}>
      ...
      <Box class="flex flex-1 flex-col overflow-hidden">
